export const Login = (props:{setActiveLog:React.Dispatch<boolean>,setActiveReg:React.Dispatch<boolean>}) => {
  return (
   ...
   <div className="mx-[10px] relative max-w-[512px] w-full rounded-[48px] flex flex-col items-center gap-[30px] bg-[#FFFFFF] py-[37px] px-[33px]">
    <div><h1 className="font-[700] text-[24px] text-black">Log In</h1></div>
