        ...
        <div className="Questions_container max-w-[848px] w-full mx-auto pb-[247px] pt-[80px]">
            <div className="questions_box flex flex-col items-center justify-center gap-[64px]">
                ...
                <div className="flex flex-col gap-[12px] items w-full">
                    <div className="w-full h-auto py-[20px] px-[24px] flex flex-col">
                        <div>
                            <div><h1>Is there free access to WIT LAB?</h1></div>
                            <div className={`${active =='1'&&'Active'}  duration-300 cursor-pointer`} onClick={()=> {
                                HandleClick('1')
...
<span>Contact Support</span></button></div>
            </div>
        </div>
    )
}